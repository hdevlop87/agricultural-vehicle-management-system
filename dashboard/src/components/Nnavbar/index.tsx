...
const Navbar = () => {
  ...
  return (
    <Card className='flex flex-row justify-between items-center w-full h-14 px-4 rounded-lg border-foreground'>

      <div className='flex justify-center items-center gap-2'>

        <NavbarSidebarTrigger />
        <Label className='text-xl font-semibold'>{pageTitle}</Label>
      </div>
