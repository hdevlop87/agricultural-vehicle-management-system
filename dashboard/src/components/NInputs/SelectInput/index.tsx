    ...
    return (
        <BaseInput variant={variant} status={status} className={cn('h-9 gap-2', className)}>
            ...
            <Select 
                ...
                value={value || ""}     
            >
                <SelectTrigger style={{ border: 'none', boxShadow: 'none' }} className="w-full border-0 shadow-none focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset- dark:bg-transparent text-muted-foreground gap-2 inputForm p-0 bg-none bg-transparent dark:hover:bg-transparent ">
